...
import BestItemFirst from '@/components/BestItemFirst.vue'
import BestItemSecond from '@/components/BestItemSecond.vue'
import BestItemThird from '@/components/BestItemThird.vue'

export default {
 components: {NavBarComponent, BestItemFirst,BestItemSecond, BestItemThird }
}
</script>
